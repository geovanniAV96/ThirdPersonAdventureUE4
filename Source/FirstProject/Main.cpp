...
AMain::AMain()
{
	...
	// Let thjat just affect the camera
...
void AMain::Tick(float DeltaTime)
{
	...
	{
		FRotator LookAtYaw = GetLKookAtRotationYaw(CombatTarget->GetActorLocation());
...
FRotator AMain::GetLKookAtRotationYaw(FVector Target)
{
...
void AMain::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("ESC", IE_Released, this, &AMain::ESCBUP);
